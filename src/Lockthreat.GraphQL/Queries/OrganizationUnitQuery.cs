...
using Lockthreat.Core.Base;
using Lockthreat.Core.Extensions;
using Lockthreat.Dto;
using Lockthreat.Types;

namespace Lockthreat.Queries
{
    public class OrganizationUnitQuery : LockthreatQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
