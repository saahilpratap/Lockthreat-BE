...
namespace Lockthreat.Core.Base
{
    public abstract class LockthreatQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected LockthreatQueryBase(string fieldName,
