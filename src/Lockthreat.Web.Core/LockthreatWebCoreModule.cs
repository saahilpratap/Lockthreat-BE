...
using Lockthreat.Web.Authentication.JwtBearer;
using Lockthreat.Web.Authentication.TwoFactor;
using Lockthreat.Web.Chat.SignalR;
using Lockthreat.Web.Configuration;
using Lockthreat.Web.DashboardCustomization;

namespace Lockthreat.Web
{
    [DependsOn(
        typeof(LockthreatApplicationModule),
        typeof(LockthreatEntityFrameworkCoreModule),
    ...
    public class LockthreatWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LockthreatWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(LockthreatApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LockthreatWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(LockthreatWebCoreModule).Assembly);
        }
