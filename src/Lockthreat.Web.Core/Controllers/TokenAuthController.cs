...
using Lockthreat.Web.Models.TokenAuth;
using Lockthreat.Authorization.Impersonation;
...
using Lockthreat.Web.Authentication.External;
...
namespace Lockthreat.Web.Controllers
{
    ...
    public class TokenAuthController : LockthreatControllerBase
    {
