...
namespace Lockthreat.Web.Public.Startup
{
    [DependsOn(
        typeof(LockthreatWebCoreModule)
    )]
    public class LockthreatWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public LockthreatWebFrontEndModule(IWebHostEnvironment env, LockthreatEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LockthreatWebFrontEndModule).GetAssembly());
        }
    }
}
