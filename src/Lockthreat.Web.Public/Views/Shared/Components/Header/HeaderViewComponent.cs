...
using Lockthreat.Web.Public.Startup;
using Lockthreat.Web.Session;

namespace Lockthreat.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : LockthreatViewComponent
    {
