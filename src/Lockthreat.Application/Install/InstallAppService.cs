...
using Lockthreat.Migrations.Seed.Host;
...
namespace Lockthreat.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : LockthreatAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<LockthreatDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(LockthreatConsts.ConnectionStringName).Value.ToString();
        }
