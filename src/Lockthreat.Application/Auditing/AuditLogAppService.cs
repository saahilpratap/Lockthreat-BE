...
using Lockthreat.Auditing.Exporting;
using Lockthreat.Authorization;
using Lockthreat.Authorization.Users;
using Lockthreat.Dto;
using Lockthreat.EntityHistory;
using EntityHistoryHelper = Lockthreat.EntityHistory.EntityHistoryHelper;

namespace Lockthreat.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : LockthreatAppServiceBase, IAuditLogAppService
    {
