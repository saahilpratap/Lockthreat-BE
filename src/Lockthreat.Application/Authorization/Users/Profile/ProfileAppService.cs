...
using Lockthreat.Authentication.TwoFactor.Google;
using Lockthreat.Authorization.Users.Dto;
using Lockthreat.Authorization.Users.Profile.Cache;
using Lockthreat.Authorization.Users.Profile.Dto;
using Lockthreat.Friendships;
using Lockthreat.Gdpr;
using Lockthreat.Identity;
using Lockthreat.Net.Sms;
using Lockthreat.Security;
using Lockthreat.Storage;
using Lockthreat.Timing;

namespace Lockthreat.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : LockthreatAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("Lockthreat",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("Lockthreat",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
