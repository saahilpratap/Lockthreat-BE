...
using Lockthreat.Authorization.Permissions;
...
using Lockthreat.Authorization.Users.Exporting;
...
namespace Lockthreat.Authorization.Users
{
    ...
    public class UserAppService : LockthreatAppServiceBase, IUserAppService
    {
