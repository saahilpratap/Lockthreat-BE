...
{
    public class SessionAppService : LockthreatAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = LockthreatConsts.Currency,
                    CurrencySign = LockthreatConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = LockthreatConsts.AllowTenantsToChangeEmailSettings,
