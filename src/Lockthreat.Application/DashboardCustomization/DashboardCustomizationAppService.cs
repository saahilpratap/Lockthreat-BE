...
using Lockthreat.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace Lockthreat.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : LockthreatAppServiceBase, IDashboardCustomizationAppService
    {
