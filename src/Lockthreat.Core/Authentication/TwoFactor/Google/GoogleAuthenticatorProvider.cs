...
namespace Lockthreat.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : LockthreatServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("Lockthreat", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
