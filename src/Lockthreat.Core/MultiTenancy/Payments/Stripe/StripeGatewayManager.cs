...
{
    public class StripeGatewayManager : LockthreatServiceBase,
        ...
        ITransientDependency
    {
        ...
        public static string ProductName = "Lockthreat";
        ...
        {
            return editionName + "_" + paymentPeriodType + "_" + LockthreatConsts.Currency;
        }
