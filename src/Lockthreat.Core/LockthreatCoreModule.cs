...
using Lockthreat.Authorization.Ldap;
...
using Lockthreat.DashboardCustomization.Definitions;
using Lockthreat.Debugging;
using Lockthreat.DynamicEntityParameters;
using Lockthreat.Features;
using Lockthreat.Friendships;
using Lockthreat.Friendships.Cache;
using Lockthreat.Localization;
using Lockthreat.MultiTenancy;
using Lockthreat.Net.Emailing;
using Lockthreat.Notifications;
using Lockthreat.WebHooks;

namespace Lockthreat
{
    [DependsOn(
        typeof(LockthreatCoreSharedModule),
        typeof(AbpZeroCoreModule),
        typeof(AbpZeroLdapModule),
        typeof(AbpAutoMapperModule),
        typeof(AbpAspNetZeroCoreModule),
        typeof(AbpMailKitModule))]
    public class LockthreatCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            LockthreatLocalizationConfigurer.Configure(Configuration.Localization);
            ...
            Configuration.MultiTenancy.IsEnabled = LockthreatConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService<IMailKitSmtpBuilder, LockthreatMailKitSmtpBuilder>(DependencyLifeStyle.Transient);
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
            {
                Configuration.IocManager.IocContainer.Register(
                    Component.For<IEmailSenderConfiguration, ISmtpEmailSenderConfiguration>()
                             .ImplementedBy<LockthreatSmtpEmailSenderConfiguration>()
                             .LifestyleTransient()
                );
            });
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LockthreatCoreModule).GetAssembly());
        }
