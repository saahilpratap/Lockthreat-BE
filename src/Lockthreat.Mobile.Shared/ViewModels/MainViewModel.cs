...
using Lockthreat.Core.Threading;
using Lockthreat.Models.NavigationMenu;
using Lockthreat.Services.Navigation;
...
using Lockthreat.ApiClient;
using Lockthreat.Controls;
using Lockthreat.Dto;
using Lockthreat.Extensions;
using Lockthreat.Localization;
using Lockthreat.UI;
using Lockthreat.UI.Assets;
using Lockthreat.Views;
using DependencyResolver = Lockthreat.Core.Dependency.DependencyResolver;
...
namespace Lockthreat.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "Lockthreat";
