...
using Lockthreat.EntityFrameworkCore.Repositories;

namespace Lockthreat.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : LockthreatRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<LockthreatDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
