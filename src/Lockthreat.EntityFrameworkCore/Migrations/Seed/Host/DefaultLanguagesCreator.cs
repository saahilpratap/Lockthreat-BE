...
namespace Lockthreat.Migrations.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LockthreatConsts.MultiTenancyEnabled ? null : (int?)1;
        ...
        public DefaultLanguagesCreator(LockthreatDbContext context)
        {
            _context = context;
        }
