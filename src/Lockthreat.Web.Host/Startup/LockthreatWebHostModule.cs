...
namespace Lockthreat.Web.Startup
{
    ...
    public class LockthreatWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public LockthreatWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(LockthreatWebHostModule).GetAssembly());
        }
