...
using Lockthreat.MultiTenancy.HostDashboard;
...
namespace Lockthreat.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(LockthreatDbContext context, SubscriptionPayment subscriptionPayment)
        {
